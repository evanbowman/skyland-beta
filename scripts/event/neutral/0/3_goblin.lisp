  ...
  (setq on-converge
        (lambda ()
          (dialog "<c:scavenger:35> Found thessse "
                  ...
                  (if (< (coins) 1300)
                      "...but you don't ssseem to have enough. Do you want to sssalvage some stuff to come up with the funds? I'll check back in 15 seconds?"
                      ""))
          (dialog-opts-reset)
          ...
          (dialog-opts-push "Take by force."
                            (lambda ()
                              ...
                              (push-pending-event (+ 2 (choice 4)) "/scripts/event/hostile/scavenger-vengence.lisp") ;;; TODO: Fix for the misspelled file name.
